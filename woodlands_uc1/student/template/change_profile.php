...
<aside>
	<form action="../pages/password.php" method="POST" class="admin-form">
	...
	<form action="../pages/changeProfilePic.php" id="profileChange" method="POST" enctype="multipart/form-data">
